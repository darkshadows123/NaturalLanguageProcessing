...
def getWords(review_sentence):
	review_words = []
	review_sentence = re.sub(r"\W"," ",review_sentence)
...
# print (nbclass_count)
temp = {}
temp['positive'] = nbclass_count['positive'] / (nbclass_count['positive'] + nbclass_count['negative'])
temp['negative'] = nbclass_count['negative'] / (nbclass_count['positive'] + nbclass_count['negative'])
temp['truthful'] = nbclass_count['truthful'] / (nbclass_count['truthful'] + nbclass_count['deceptive'])
temp['deceptive'] = nbclass_count['deceptive'] / (nbclass_count['truthful'] + nbclass_count['deceptive'])

prior = {}
prior['prior_probability'] = temp
merged_dict = merge_two_dicts(nbProbability, prior)
